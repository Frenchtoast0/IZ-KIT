...
char* jessessid = "NodeMCU";
const char* jessepassword = "passverd";
const char* webService = "thor.net.nait.ca/~izkit/webservice.php";
...
void setup()
{
  ...
  if (WiFi.status() == WL_CONNECTED)
  {
    ...
    int httpCode = client.POST("action=Test");
